...
| [![Camera](docs/images/camera_screenshot.png)](https://novikovnick.github.io/geometry-sandbox/demo/camera/) | **Camera** <br><br> 3D Camera Example:<br>Orthographic: isometric, dimetric, and trimetric projections<br>Perspective: top-down view demonstrating FOV changes and the underlying trigonometry<br>Side-by-side comparison of FOV changes — external view vs. in-camera view<br>Switching from perspective to orthographic projection<br>Demonstrating that swapping right/left coordinate systems is simply mirroring<br> The math behind project/deproject <br><br> Work in progress...|
