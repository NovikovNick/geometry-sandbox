...
function findWasmBinary() {
  return locateFile('mesh-cutter.wasm');
}
...
var ASM_CONSTS = {
  93320: () => { if (document.fullscreenElement) return 1; },  
 93366: () => { return document.getElementById('canvas').width; },  
 93418: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93486: () => { document.exitFullscreen(); },  
 93513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93586: () => { if (document.fullscreenElement) return 1; },  
 93632: () => { return document.getElementById('canvas').width; },  
 93684: () => { return screen.width; },  
 93709: () => { document.exitFullscreen(); },  
 93736: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93869: () => { return window.innerWidth; },  
 93895: () => { return window.innerHeight; },  
 93922: () => { if (document.fullscreenElement) return 1; },  
 93968: () => { return document.getElementById('canvas').width; },  
 94020: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94088: () => { if (document.fullscreenElement) return 1; },  
 94134: () => { return document.getElementById('canvas').width; },  
 94186: () => { return screen.width; },  
 94211: () => { return window.innerWidth; },  
 94237: () => { return window.innerHeight; },  
 94264: () => { if (document.fullscreenElement) return 1; },  
 94310: () => { return document.getElementById('canvas').width; },  
 94362: () => { return screen.width; },  
 94387: () => { document.exitFullscreen(); },  
 94414: () => { if (document.fullscreenElement) return 1; },  
 94460: () => { return document.getElementById('canvas').width; },  
 94512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94580: () => { document.exitFullscreen(); },  
 94607: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94665: () => { return screen.width; },  
 94690: () => { return screen.height; },  
 94716: () => { return window.screenX; },  
 94743: () => { return window.screenY; },  
 94770: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94823: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94894: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94951: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95207: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95278: () => { if (document.fullscreenElement) return 1; },  
 95324: () => { return window.innerWidth; },  
 95350: () => { return window.innerHeight; },  
 95377: () => { if (document.pointerLockElement) return 1; }
};
